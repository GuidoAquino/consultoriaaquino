            ...
            <div class="lg:w-1/2 lg:mx-6">
              ...
              <div class="mt-6 space-y-8 md:mt-8">
                <p class="flex items-start -mx-2">
                  <svg
                    ...
                    class="w-6 h-6 mx-2 text-[--turquesa]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
              ...
              <div class="mt-6 w-80 md:mt-8">
                ...
                <div class="flex mt-4 -mx-1.5 ">
                  ...
                  <a
                    class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                    href="https://www.linkedin.com/in/mariano-aquino-01836111/" target="_blank"
                  >
                    <svg
                      class="w-8 h-8"
                      viewBox="0 0 24 24"
            ...
            <div class="mt-8 lg:w-1/2 lg:mx-6">
              <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
                ...
                <form class="mt-6">
                  ...
                  <button class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[--azuloscuro] rounded-md hover:bg-[#083a5e] focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                    get in touch
                  </button>
                </form>
              </div>
